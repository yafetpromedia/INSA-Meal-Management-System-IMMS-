    ...
    <AppShell>
      ...
      <form onSubmit={onSubmit}>
        <ActivityReportFormShell
          ...
          subtitle="Write in the official template. Changes auto-save while you work."
            ...
            <div className="art-form-stack">
              {(
                [
                  ...
                  ['activitiesPerformed', 'Activities performed', false],
                ...
                <label className="field" key={key}>
                  <span>
                    {label}
                    {!required ? <em className="muted"> · optional</em> : null}
                  </span>
                  <textarea
